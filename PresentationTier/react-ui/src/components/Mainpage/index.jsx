        ...
        const fetchData = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    console.log(data);
                    setRows(Array.isArray(data.docs) ? data.docs : []); // Ensure data.docs is an array or use an empty array if it's not.
                } else {
                    console.error('Failed to fetch data');
                }
            } catch (error) {
                console.error('Error:', error);
                setRows([]); // Set rows to an empty array in case of an error.
            }
        };
